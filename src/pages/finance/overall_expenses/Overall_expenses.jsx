              ...
              <button
                ...
                className={`py-2 px-3 rounded-md text-sm font-medium ${
                  activeTab === tab.id
                    ...
                    : "text-black bg-white dark:bg-layout-dark dark:text-white font-light font-roboto-flex"
                }`}
...
export default Overall_expenses;