...
import SampleHSNExcel from "./HSN.xlsx";
import { API } from "../../../constant";


const UploadHSN = ({ onclose, onSuccess }) => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      if (files.length === 1) {
        ...
        await axios.post(`${API}/hsn/uploadcsv`, formData, {
