...
const ViewSiteDrawing = () => {
  ...
  const updateField = (key, newValue, section) => {
    const setter = section === "main" ? setMainFields : '';
    const data = section === "main" ? mainFields : '';
...
export default ViewSiteDrawing;
